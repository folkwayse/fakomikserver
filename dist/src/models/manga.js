...
export const hasUpdateManga = async (updateData) => {
    try {
...
export const advSearch = async (data) => {
    try {
...
export const createNewManga = async (manga) => {
    try {
...
export const MangaByIds = async (ids) => {
    try {
...
export const MangaById = async (id) => {
    try {
...
export const newManga = async (page = 1) => {
    try {
        const mangas = await prisma.manga.findMany({
...
export const newChapter = async (page = 1) => {
    try {
        const mangas = await prisma.manga.findMany({
            take: 24, // Limit to 24 items per page
            skip: (page - 1) * 24,
...
export const mangaBySlug = async (slug) => {
    try {
        const manga = await prisma.manga.findUnique({
            where: {
                slug,
...
export const mangaByName = async (s) => {
    try {
        const mangas = await prisma.manga.findMany({
            where: {
                title: {
