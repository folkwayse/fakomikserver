import { addNewChapter, ChapterBySlug, prevNextChapter, chapterTitle, isSlugExists } from "../models/chapter";
export const addChapter = async (c) => {
...
export const checkChapterSlug = async (c) => {
...
export const getChapterBySlug = async (c) => {
...
export const getPrevNextChapter = async (c) => {
    const slug = await c.req.param("slug");
